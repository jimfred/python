...
#define SWIGTYPE_p_unsigned___int64 swig_types[10]
...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__Dll2

#else
#  define SWIG_init    init_Dll2

#endif
#define SWIG_name    "_Dll2"
...
extern "C" {
#endif
SWIGINTERN int Swig_var_nDll2_set(PyObject *_val) {
  {
    int val;
    int res = SWIG_AsVal_int(_val, &val);
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""nDll2""' of type '""int""'");
    }
    nDll2 = static_cast< int >(val);
  }
  return 0;
fail:
  return 1;
...
SWIGINTERN PyObject *Swig_var_nDll2_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_From_int(static_cast< int >(nDll2));
  return pyobj;
}


SWIGINTERN PyObject *_wrap_fnDll2(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int result;
  
  if (!SWIG_Python_UnpackTuple(args, "fnDll2", 0, 0, 0)) SWIG_fail;
  result = (int)fnDll2();
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "fnDll2", _wrap_fnDll2, METH_NOARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
...
# endif
  ...
  Py_DECREF(globals);
  SWIG_addvarlink(globals, "nDll2", Swig_var_nDll2_get, Swig_var_nDll2_set);
#if PY_VERSION_HEX >= 0x03000000
  return m;
#else
  return;
